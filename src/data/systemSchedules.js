export const systemSchedules = [
    ...
    {
        id: 'sys-hala-parallel-0115',
        name: 'Hala FM 1:15 AM Parallel',
        stationId: '2',
        url: 'https://hala-alrayamedia.radioca.st/;',
        time: '01:15',
        days: [0, 1, 2, 3, 4, 5, 6],
    ...
    {
        id: 'sys-jhusna-parallel-0115',
        name: 'JHusna FM 1:15 AM Parallel',
        stationId: '18',
    ...
    {
        id: 'sys-jrtv-parallel-0115',
        name: 'JRTV 1:15 AM Parallel (HLS Fix)',
        stationId: '8',
