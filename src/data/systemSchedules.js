export const systemSchedules = [
    ...
    {
        id: 'sys-hala-parallel-0030',
        name: 'Hala FM 12:30 AM Parallel',
        stationId: '2',
        url: 'https://hala-alrayamedia.radioca.st/;',
        time: '00:30',
        days: [0, 1, 2, 3, 4, 5, 6],
    ...
    {
        id: 'sys-jhusna-parallel-0030',
        name: 'JHusna FM 12:30 AM Parallel',
        stationId: '18',
    ...
    {
        id: 'sys-jrtv-parallel-0030',
        name: 'JRTV 12:30 AM Parallel (HLS Fix)',
        stationId: '8',
